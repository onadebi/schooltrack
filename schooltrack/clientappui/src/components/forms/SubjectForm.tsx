...
const SubjectForm: React.FC<IPropsTableForm<RegInput>> = ({type, data}) => {
  ...
  return (
    ...
    <form className="flex flex-col gap-8" onSubmit={OnSubmit}>
        ...
        <div className="flex flex-wrap gap-8">
          ...
          <FormInputField label='teachers' type='teachers' register={register} name='teachers' error={errors?.teachers?.[0]} defaultValue={data?.teachers?.join(', ')} inputProps={{placeholder: 'teachers'}}/>
        </div>
